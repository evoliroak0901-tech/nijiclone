          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
            {STYLES.map(style => (
              <button
                ...
                className={`flex-shrink-0 relative w-24 h-32 rounded-lg overflow-hidden border-2 transition-all ${
                  selectedStyle === style.id ? 'border-indigo-600 ring-2 ring-indigo-100' : 'border-transparent'
                }`}
              >
            ...
            {MODELS.map(model => (
              <button
                ...
                className={`flex-shrink-0 relative w-24 h-24 rounded-lg overflow-hidden border-2 transition-all ${
                  activeModel === model.id ? 'border-indigo-600 ring-2 ring-indigo-100' : 'border-transparent opacity-70 hover:opacity-100'
                }`}
              >
